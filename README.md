...
- 生成入力: テキストまたは URL、サイズ (128/256/512 px)、誤り訂正レベル (L/M/Q/H)
- 解析入力: 画像ペースト、Drag&Drop、ファイル選択
- 期待する確認ポイント:
	- 生成した QR コード画像がリアルタイムでプレビューされ、PNG でダウンロードできる
	- アップロードした QR 画像からテキストを抽出して表示できる
	- 解析結果テキストをワンクリックでクリップボードへコピーできる
